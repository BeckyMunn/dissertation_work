...
try
{
    if (isset($_GET['from'])){
        ...
        $sql_date_range = "SELECT date FROM `schedules` WHERE date BETWEEN '$dateFrom' and '$dateTo' ORDER BY date";
        $date_range = $pdo->query($sql_date_range);
        $sql_sound_console_last_used = "SELECT vol_id FROM `volunteer_roles` WHERE role_id = '1' ORDER BY last_used";
        $sound_console_last_used = $pdo->query($sql_sound_console_last_used);
        $sql_mics_last_used = "SELECT vol_id FROM `volunteer_roles` WHERE role_id = '2' ORDER BY last_used";
        ...
        $sql_car_watch_last_used = "SELECT vol_id FROM `volunteer_roles` WHERE role_id = '4' ORDER BY last_used";
        $car_watch_last_used = $pdo->query($sql_car_watch_last_used);
        $sql_door_watch_last_used = "SELECT vol_id FROM `volunteer_roles` WHERE role_id = '5' ORDER BY last_used";
...
//--------------------------------------------- Create schedule
        while ($row = $date_range ->fetch())
        {
            ...
            $sql_update_sound_last_used = "UPDATE volunteer_roles SET last_used = '$date_row' WHERE $vol_id and role_id = 1";
        ...
        //--------------------------------------------- Mics
            ...
            $vol_id = $row['vol_id'];
            $sql_update_mics = "UPDATE schedules SET platform_mic = $vol_id WHERE date = '$date_row'";
            $update_mics = $pdo->query($sql_update_mics);
            $sql_update_mics_last_used = "UPDATE volunteer_roles SET last_used = '$date_row' WHERE $vol_id and role_id = 3";
            ...
            $update_mics = $pdo->query($sql_update_mics);
            $sql_update_mics_last_used = "UPDATE volunteer_roles SET last_used = '$date_row' WHERE $vol_id and role_id = 2";
            $update_mics_last_used = $pdo->query($sql_update_mics_last_used);
            ...
            $update_sound = $pdo->query($sql_update_sound);
            $sql_update_car_last_used = "UPDATE volunteer_roles SET last_used = '$date_row' WHERE $vol_id and role_id = 4";
            ...
            $sql_update_door_last_used = "UPDATE volunteer_roles SET last_used = '$date_row' WHERE $vol_id and role_id = 5";
